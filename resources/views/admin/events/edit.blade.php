                    ...
                    <form action="{{ route('events.update', $event->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            class="mt-1 block w-full px-3
                             ...
                             focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$event->name}}">
                             @error('name')
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{$event->description}}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            class="mt-1 block w-full px-3
                             py-2 bg-white border border-gray-300 
                             rounded-md shadow-sm placeholder-gray-400 focus:outline-none 
                             focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$event->date}}">
                             @error('date')
                             <span class="text-red-600 text-sm">{{ $message }}</span>
                         @enderror
                        </div>
                        ...
                        <div>
                            ...
                            class="mt-1 block w-full px-3
                             py-2 bg-white border border-gray-300 
                             rounded-md shadow-sm placeholder-gray-400 focus:outline-none 
                             focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$event->location}}">
                        </div>
