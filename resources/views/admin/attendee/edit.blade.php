                    ...
                    <form action="{{ route('attendees.update', $attendee->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            class="mt-1 block w-full px-3
                             ...
                             focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$attendee->name}}">
                             @error('name')
                        ...
                        <div>
                            ...
                            class="mt-1 block w-full px-3
                             py-2 bg-white border border-gray-300 
                             rounded-md shadow-sm placeholder-gray-400 focus:outline-none 
                             focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$attendee->email}}">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="event_id" id="event_id" 
                                ...
                                <option value="{{$event->id}}" {{  $event->id == $attendee->event_id ? 'selected' : '' }} >{{$event->name}}</option>
